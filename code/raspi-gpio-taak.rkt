...
(define gpio-i2c-setup
  (get-ffi-obj "wiringPiI2CSetup" wiringpi-lib (_fun _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CSetup missing"))))

(define gpio-i2c-read
  (get-ffi-obj "wiringPiI2CRead" wiringpi-lib (_fun _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CRead missing"))))

(define gpio-i2c-write
  (get-ffi-obj "wiringPiI2CWrite" wiringpi-lib (_fun _int32 _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CWrite missing"))))

(define gpio-i2c-write-reg8
  (get-ffi-obj "wiringPiI2CWriteReg8" wiringpi-lib (_fun _int32 _int32 _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CWriteReg8 missing"))))

(define gpio-i2c-write-reg16
  (get-ffi-obj "wiringPiI2CWriteReg16" wiringpi-lib (_fun _int32 _int32 _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CWriteReg16 missing"))))

(define gpio-i2c-read-reg8
  (get-ffi-obj "wiringPiI2CReadReg8" wiringpi-lib (_fun _int32 _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CReadReg8 missing"))))

(define gpio-i2c-read-reg16
  (get-ffi-obj "wiringPiI2CReadReg16" wiringpi-lib (_fun _int32 _int32 -> _int32)
               (lambda () (error 'wiringpi-lib "wiringPiI2CReadReg16 missing"))))


;; LSM303D

(require "lsm303d.rkt") ; bevat constanten voor de registeraddressen

(define (lsm303d-setup fd) ; initialiseer de controle-registers
  (gpio-i2c-write-reg8 fd LSM303D_CTRL1 #b01010111)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL2 #b00000000)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL3 #b00000000)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL4 #b00000000)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL5 #b10010000)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL6 #b00000000)
  (gpio-i2c-write-reg8 fd LSM303D_CTRL7 #b00001000))
